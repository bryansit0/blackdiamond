...
<div class="col-md-12 mt-3">
      ...
      <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control bg-dark text-white mt-2" name="modelo" value="{{ $producto->modelo }}">
      </div>


      <div class="form-group col-md-6 mb-3 mt-3">
        <label for="precio">Precio</label>
        <input type="number" class="form-control bg-dark text-white mt-2" name="precio" value="{{ $producto->precio }}">
      </div>


      <div class="form-group col-md-6 mb-3 mt-3">
        <label for="descripcion">Descripción</label>
        <textarea class="form-control bg-dark text-white mt-2" name="descripcion">{{ $producto->descripcion }}</textarea>
      </div>


      <div class="form-group col-md-6 mb-3 mt-3">
        <label for="nombreProducto">Nombre del producto</label>
        <input type="text" class="form-control bg-dark text-white mt-2" name="nombreProducto" value="{{ $producto->nombreProducto }}">
      </div>


      <div class="form-group col-md-6 mb-3 mt-3">
        <label for="cantidadProducto">Cantidad del producto</label>
        <input type="number" class="form-control bg-dark text-white mt-2" name="cantidadProducto" value="{{ $producto->cantidadProducto }}">
      </div>


      <div class="form-group col-md-6 mb-3 mt-3">
        <label for="numeroCompras">Número de compras</label>
        <input type="number" class="form-control bg-dark text-white mt-2" name="numeroCompras" value="{{ $producto->numeroCompras }}">
      </div>
      ...
      <div class="form-group col-md-6 mb-3">
        ...
        <input type="number" class="form-control bg-dark text-white" name="numeroVotos" value="{{ $producto->numeroVotos }}">
      </div>
